...
const SubscriptionForm = () => {
  return (
    <div
      className="relative w-80 lg:w-[1200px] lg:-mb-28 -mb-24 mx-auto rounded-2xl px-8 py-8 h-48 lg:h-64 mt-8 bg-cover bg-center"
    ...
    >
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 w-full px-8">
        <div className="flex justify-center items-center space-x-0">
          ...
          />
          <button className="bg-purple-500 text-white px-6 py-3 rounded-r-lg w-[150px]">
            Subscribe
          </button>
        </div>
